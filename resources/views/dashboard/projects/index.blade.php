...
<div class="table-responsive col-lg-8">
  <a href="/dashboard/projects/create" class="btn btn-primary mb-3"> Create new Projects </a>
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td></td>
          <td>
            <a href="/dashboard/projects/{{ $project->slug }}" class="badge bg-info">  <span data-feather="eye" class="align-text-bottom"></span> </a>
